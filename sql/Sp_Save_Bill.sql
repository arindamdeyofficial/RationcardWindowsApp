...
--    </ProductsSold>
--  </BillDetails>
--  <BillDetails NumberOfCards="3" CardNumbers="RationCard.Model.RationCardDetailExtended,RationCard.Model.RationCardDetailExtended,RationCard.Model.RationCardDetailExtended">
--    <CardCategory />
